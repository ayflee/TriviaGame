...
// All Questions
var question1 = new Question("At what age do puppies start teething?", ['4 weeks', '8 weeks', '8 months'], '8 months');
var question2 = new Question("How long can a 3 month old puppy hold its bladder?", ['1 hour', '4 hours', '8 hours'], '4 hours');
var question3 = new Question("Do small breeds mature into adulthood faster than big breeds?", ['Yes', 'No', 'Same rate'], 'Yes');
var question4 = new Question("When does a female puppy go into first heat?", ['3 months', '7 months', '18 months'], '7 months');
var question5 = new Question("How many hours of sleep do very young puppies need?", ['6 hours', '10 hours', '18 hours'], '18 hours');
...
// Randomize Questions
var randomQ = puppiesQ[Math.floor(Math.random() * puppiesQ.length)];
